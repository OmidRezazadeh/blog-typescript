...
AdminUserRouter.get('/list',authenticated as express.RequestHandler, checkAdminRoleMiddleware as express.RequestHandler ,AdminUsersController.list.bind(AdminUsersController)  )